...
// IN: Marker interfaces define a contract with no members.
...
// IN: Inheriting from INotification allows MediatR to dispatch
...
public interface IDomainEvent : INotification
{
    ...
    // IN: OccurredOn enables event sourcing patterns later
